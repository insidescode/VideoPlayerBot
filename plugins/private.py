...
async def start(client, message):
   buttons = [
            ...
            [
                ...
                InlineKeyboardButton("📦 Source Code", url=f"https://www.youtube.com/watch?v=dQw4w9WgXcQ"),
            ],
            [
            ...
            [
               InlineKeyboardButton("➕ ADD THIS BOT", url=f"https://t.me/{USERNAME}?startgroup=true"),
            ]
            ]
